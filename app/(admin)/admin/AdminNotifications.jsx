...
const allCourses = [
    { id: '1', name: 'RELUL 2020',content: "Tenes solicitudes pendientes"},
    { id: '2', name: 'RELUL 2022',content: "Tenes solicitudes pendientes"},
    { id: '3', name: 'RELAL 2023',content: "Tenes solicitudes pendientes"},
...
const AllCoursesList = () => {
    ...
    const renderItem = ({ item, index }) => {
        return(
            ...
            onPress={() => router.push({ pathname: '/admin/AdminNotifications', params: { screen: 'CourseAdmin' } })}>
